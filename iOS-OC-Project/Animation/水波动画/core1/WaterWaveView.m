...
@property (nonatomic, strong) WaterWaveLayer *waveLayer;
...
- (void)setupUI {
    ...
    _waveLayer = [WaterWaveLayer layer];
...
- (void)layoutSubviews {
    ...
    CGRect rect = _circleLayer.bounds;
    rect.size.width = _waveLayer.instanceCount * _circleLayer.bounds.size.width;
    _waveLayer.frame = rect;
}
